      ...
      <div className="max-w-7xl mx-auto">
        ...
        {!profileExists && (
          <div className="text-center mb-8 bg-blue-900/30 p-6 rounded-lg shadow-lg">
            <p className="mb-4 text-lg">Complete your profile to connect with other students</p>
            <Link
              to="/profile-setup"
        ...
        {filteredStudents.length === 0 ? (
          <div className="text-center p-8 bg-gray-800/50 rounded-lg">
            <p className="text-xl text-gray-300">No students match your search criteria</p>
          </div>
        ) : (
              ...
              >
                ...
                <div className="text-center space-y-3">
                  <Link
                    ...
                    className="block px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition duration-300 shadow-md"
                  >
                    View Profile
                  </Link>
                  {student.linkedin && (
                    <a
                      ...
                      className="block px-4 py-2 bg-blue-800 text-white rounded-lg hover:bg-blue-900 transition duration-300 shadow-md flex items-center justify-center"
                    >
