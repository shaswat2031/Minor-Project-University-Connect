...
const ProfileSetup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-900 via-gray-900 to-black text-white py-10">
      ...
      >
        <h2 className="text-4xl font-extrabold mb-8 text-center bg-gradient-to-r from-blue-400 to-purple-500 text-transparent bg-clip-text">Set Up Your Profile</h2>
        <form onSubmit={handleSubmit} className="space-y-8">
          {/* Basic Details */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-blue-400 mb-3">Basic Information</h3>
            <motion.div
          ...
          {/* Skills Section */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-blue-400 mb-3">Skills & Social Media</h3>
            <motion.div
              whileHover={{ scale: 1.01 }}
              transition={{ type: "spring", stiffness: 400, damping: 10 }}
            ...
            >
              ...
              />
              <span className="px-4 text-blue-400 cursor-pointer hover:text-blue-300 text-xl">+</span>
            </motion.div>
          ...
          <div className="space-y-4">
            ...
            {education.map((edu, index) => (
              ...
              >
                <div className="text-sm text-blue-300 mb-2">Education #{index + 1}</div>
                <motion.input
                  type="text"
                  placeholder="Degree"
          ...
          <div className="space-y-4">
            ...
            {experience.map((exp, index) => (
              <motion.div 
                ...
                transition={{ duration: 0.3 }}
              >
                <div className="text-sm text-blue-300 mb-2">Experience #{index + 1}</div>
                <motion.input
                  type="text"
                  placeholder="Role"
                  className="w-full p-3 border border-blue-500/40 rounded-lg bg-[#131a2b] text-white focus:outline-none focus:ring-2 focus:ring-blue-400 transition-all"
